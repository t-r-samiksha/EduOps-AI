...
export const NAV_ITEMS: Record<Role, NavEntry[]> = {
  admin: [
    ...
    { label: "Timetable", path: "/admin/timetable", icon: CalendarClock },
    {
      ...
      children: [
        ...
        { label: "Gradebook & Report Cards", path: "/admin/gradebook", icon: GraduationCap },
  ...
  principal: [
    ...
    { label: "Timetable", path: "/principal/timetable", icon: CalendarClock },
    {
      ...
      children: [
        ...
        { label: "Gradebook & Report Cards", path: "/principal/gradebook", icon: GraduationCap },
  ...
  teacher: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Gradebook & Report Cards", path: "/teacher/gradebook", icon: GraduationCap },
  ...
  student: [
    ...
    },
    {
      ...
      icon: TrendingUp,
      children: [
        { label: "Grades & Report Cards", path: "/student/gradebook", icon: GraduationCap },
  ...
  parent: [
    ...
    { label: "Grades & Report Cards", path: "/parent/gradebook", icon: GraduationCap },
